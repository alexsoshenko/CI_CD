...
![](https://github.com/alexsoshenko/CI_CD/tree/images/GitFlow.png)
> Git Flow

![](https://github.com/alexsoshenko/CI_CD/tree/images/GitFlowDetailed.png)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/SemVer.png)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/CIFlow.jpg)

> CI pipeline design

The build system is designed to implement the CI/CD Process which is shown on the following figure:

![](https://github.com/alexsoshenko/CI_CD/tree/images/CI_CDProcessforNetApplication.jpg)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/azureDevOpsVersioning.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/useNuGet430Installer.JPG)

### 4. Restore NuGet packages

![](https://github.com/alexsoshenko/CI_CD/tree/images/NuGetRestore.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/prepareAnalysisSQ.JPG)

This step is optional.
Fill the gaps with next build variables:
![](https://github.com/alexsoshenko/CI_CD/tree/images/SQcfg.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/buildMSBuild.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/VSTestPI.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/VStest_testAssemblies.JPG)

If project already has Unit tests add this build step.

Fill the gaps with next build variables:

![](https://github.com/alexsoshenko/CI_CD/tree/images/RunUnitcfg.JPG)

**Test Files** - list of Test files
**Search Folder** - folder, where tests will be run

![](https://github.com/alexsoshenko/CI_CD/tree/images/RunUnitcfg2.JPG)

Do not forget to enable Code Coverage.

### 9. Run Code Analysis

![](https://github.com/alexsoshenko/CI_CD/tree/images/RunCodeAnalysis.JPG)

This Step is optional.

### 10. Publish Quality Gate Result

![](https://github.com/alexsoshenko/CI_CD/tree/images/PublishQGResult.JPG)

This Step is optional.

### 11. Create NuGet package

![](https://github.com/alexsoshenko/CI_CD/tree/images/NuGetPack.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/NuGetPush.JPG)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/CDFlow.jpg)
...
![](https://github.com/alexsoshenko/CI_CD/tree/images/PushToAppService.JPG)
